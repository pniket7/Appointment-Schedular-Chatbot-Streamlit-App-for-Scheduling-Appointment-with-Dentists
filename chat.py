...
def main():
    ...
    # Create a text area widget and store its value in the session state
    ...
    # Accept user input
    st.text_area("Type your message here...", key="widget", height=100, value=st.session_state.user_input, on_change=submit)
